...
51 production-tested skills + 5 companion CLIs included. Install any with `harness-ai-kit add skill <id>` (or `pip install sf-<cli>`). Full categorized index: **[CATALOG.md](CATALOG.md)**.
