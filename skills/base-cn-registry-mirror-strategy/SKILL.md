...
- 长篇可复制片段与命令：`references/REFERENCE-MIRROR-RECIPES.md`（在 `team-ai-kit` 仓库内路径为 `skills/base-cn-registry-mirror-strategy/references/REFERENCE-MIRROR-RECIPES.md`；若以「02-工程工作空间」为根，则为 `工程规范/team-ai-kit/skills/base-cn-registry-mirror-strategy/references/REFERENCE-MIRROR-RECIPES.md`）
