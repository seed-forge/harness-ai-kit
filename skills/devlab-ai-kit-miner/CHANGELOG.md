...
- 新增「八、与审查流水线的关系」：沉淀候选经 historyminerctl push 进草稿队列，由 team-ai-kit-review-ops 审查后融合，不直提交。

## 0.4.1 - 2026-07-24

- 补全 Human Decision 结构（Skill 组织规范 §5）：新增 `decisions.yaml`（HD-1 提炼资产是否推进创建/发布）+ SKILL.md `## Human Decisions` 汇总表。（team-ai-kit-audit-ops HD 治理 P2 批）
...
- 新增"与 team-ai-kit-forge 的接力"章节，明确复盘→创建的无缝链路。
