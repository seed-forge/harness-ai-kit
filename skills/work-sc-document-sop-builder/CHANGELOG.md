...
- 补全 Human Decision 结构（Skill 组织规范 §5）：新增 `decisions.yaml`（HD-1 文档导出确认）+ SKILL.md `## Human Decisions` 汇总表。（team-ai-kit-audit-ops HD 治理 P2 批）

## 0.1.0 (migrated)

- 从 03 空间 `document-reference-sop-builder` 迁移到 team-ai-kit 并重命名为 `work-sc-document-sop-builder`
- 归属 work-sc 命名空间，声明 depends on docx + pdf
# Changelog

## 0.1.0 - 2026-05-09

- onboarded `document-reference-sop-builder` into `team-ai-kit`
