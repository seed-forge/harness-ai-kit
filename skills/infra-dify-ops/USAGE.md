# infra-dify-ops Usage

## When To Use
- Use this skill when you need to 面向 组织内部集群 中 Dify 使用层资源运维的共享 Skill，覆盖 app 检查、DSL 摘要、本地资源沉淀、资源清单批量计划、workflow 草稿生成、Studio 自动化，以及 Dify 1.13.x workflow 兼容性修复与生产验收.
