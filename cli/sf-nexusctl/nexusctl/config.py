"""nexusctl unified config — thin wrapper over asset_config_loader."""
...
LEGACY_PATHS = [Path.home() / '.config' / 'nexusctl' / 'config.yaml']
...
def get_state_dir() -> Path:
    """Return ~/.harness-ai-kit/state/nexusctl/, creating if needed."""
