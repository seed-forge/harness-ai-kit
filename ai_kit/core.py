...
if __package__:
    ...
    from ai_kit.product import PRODUCT_ENV_VAR, ProductProfile, active_product_profile
    from ai_kit.application.project_manifest import ProjectManifestPorts, ProjectManifestService
    from ai_kit.commands.bootstrap import BootstrapCommandContext, build_bootstrap_handlers
    ...
    from ai_kit.commands.inspect import InspectCommandContext, build_inspect_handlers
    from ai_kit.commands.project import ProjectCommandContext, build_project_config_handlers, build_project_plain_handlers
    from ai_kit.commands.resolution import ResolutionCommandContext, build_resolution_handlers
    ...
    from ai_kit.domain import doctor_registry_lock
    ...
    from ai_kit.infrastructure.cli_installer import (
        binary_release_checksum,
        binary_release_checksum_urls,
        binary_release_download,
        binary_release_install_path,
    ...
    from ai_kit.domain.scaffold import scaffold_cli, scaffold_managed_asset, scaffold_skill
    from ai_kit.domain.doctor_checks import (
        current_platform_tags,
        doctor_assets_results,
        doctor_drift_results,
        doctor_env_results,
    ...
    from ai_kit.commands.validate import run_repo_validation
    ...
    from ai_kit.infrastructure.registry_skill import (
    ...
    from ai_kit.infrastructure.registry_cli import (
    ...
    from ai_kit.domain.install_state import (
    ...
    from ai_kit.infrastructure.git_ops_extra import (
    ...
    from ai_kit.domain.lifecycle import (
    ...
    from ai_kit.infrastructure.release_ops import (
    ...
    from ai_kit.domain.report_presentation import (
        format_table, format_skill_table, format_managed_asset_table, format_cli_table,
    )
    from ai_kit.commands.install_git_select import choose_git_skill_interactively
    from ai_kit.domain.runtime_install import resolve_target_dir
    from ai_kit.domain.dependency_expansion import (
