...
from ai_kit.commands.install import resolve_install_external
...
def command_upgrade(args: argparse.Namespace, config_path: Path, context: UpgradeCommandContext) -> int:
    ...
    if install_scope_override == "global":
        ...
        from ai_kit.domain.manifest_ops import load_project_manifest, save_project_manifest, project_manifest_from_lockfile
