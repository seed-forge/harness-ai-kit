...
def add_inspect_resolution_parsers(subparsers: Any, *, runtime_choices: Sequence[str]) -> None:
    ...
    resolve_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    lock_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    graph_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    why_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    show_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    cat_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    cache_parser = subparsers.add_parser("cache", help="Inspect or clean the local ai-kit package cache.")
...
def add_project_runtime_parsers(subparsers: Any, *, runtime_choices: Sequence[str], all_asset_types: Sequence[str]) -> None:
    init_project_parser = subparsers.add_parser("init-project", help="Create ai-kit.yml for the current project.")
    init_project_parser.add_argument("--runtime", choices=runtime_choices, default="codex", help="Runtime to write into ai-kit.yml.")
    init_project_parser.add_argument("--scope", choices=["project", "global"], default="project", help="Scope to write into ai-kit.yml.")
    ...
    init_project_parser.add_argument("--force", action="store_true", help="Overwrite an existing ai-kit.yml.")
    ...
    manifest_migrate_parser = manifest_subparsers.add_parser("migrate", help="Rewrite ai-kit.yml to the v2 unified asset format.")
    manifest_migrate_parser.add_argument("--dry-run", action="store_true", help="Print the migrated manifest without writing it.")

    add_parser = subparsers.add_parser("add", help="Add one asset to ai-kit.yml and sync the project by default.")
    ...
    add_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    add_parser.add_argument("--no-install", action="store_true", help="Only update ai-kit.yml without syncing runtime state.")
    ...
    remove_parser = subparsers.add_parser("remove", help="Remove one asset from ai-kit.yml and reconcile runtime state.")
    ...
    remove_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    remove_parser.add_argument("--no-install", action="store_true", help="Only update ai-kit.yml without syncing runtime state.")

    sync_parser = subparsers.add_parser("sync", help="Reconcile the current project to ai-kit.yml.")
    ...
    sync_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    prune_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    prune_parser.add_argument("--offline", action="store_true", help="Resolve using local cache only for registry-backed skills.")

    outdated_parser = subparsers.add_parser("outdated", help="Show upgrade status for assets declared in ai-kit.yml.")
    outdated_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    diff_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    diff_parser.add_argument("--offline", action="store_true", help="Resolve using local cache only for registry-backed skills.")

    uninstall_parser = subparsers.add_parser("uninstall", help="Remove an installed skill or CLI without touching ai-kit.yml.")
    ...
    uninstall_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    deprecate_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    retire_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    for command_name in ("install", "update"):
        ...
        command_parser.add_argument("skill_ids", nargs="*", help="Legacy skill IDs or explicit selectors like `skill foo` or `cli ai-kit`.")
        ...
        command_parser.add_argument("--runtime", choices=runtime_choices, default=None, help="Target runtime for skill installation. Defaults to ai-kit.yml or codex.")
        command_parser.add_argument("--scope", choices=["project", "global"], default=None, help="Install scope for skills. Defaults to ai-kit.yml or project.")
        ...
        command_parser.add_argument("--refresh-lock", action="store_true", help="Ignore the existing ai-kit.lock and resolve again.")
        ...
        command_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    upgrade_parser.add_argument("asset_ids", nargs="*", help="Explicit selectors like `skill writer` or `cli ai-kit`. With `--all`, upgrades both skills and CLIs.")
    ...
    upgrade_parser.add_argument("--runtime", choices=runtime_choices, default=None, help="Target runtime for skill upgrades. Defaults to ai-kit.yml or codex.")
    upgrade_parser.add_argument("--scope", choices=["project", "global"], default=None, help="Install scope for skill upgrades. Defaults to ai-kit.yml or project.")
    upgrade_parser.add_argument("--feature", action="append", default=[], help="Override enabled project features during upgrade.")
    upgrade_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
...
def add_loop_parsers(subparsers: Any) -> None:
    ...
    from ai_kit.commands.loop_run import add_run_parser
...
def add_authoring_publish_release_parsers(subparsers: Any, *, runtime_choices: Sequence[str]) -> None:
    ...
    create_skill_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    for managed_type in ("plugin", "hook", "subagent", "mcp", "loop"):
        ...
        managed_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    create_cli_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    submit_skill_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    for managed_type in ("plugin", "hook", "subagent", "mcp", "loop"):
        ...
        managed_submit_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    submit_cli_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    publish_skill_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    publish_cli_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    publish_parser.add_argument("paths", nargs="*", help="Repo-relative file or directory paths to stage, such as catalog.md or cli/ai_kit/main.py.")
    ...
    publish_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_skill_build_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_skill_publish_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_version_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_bump_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_build_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_check_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_publish_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    publish_loop_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
    ...
    release_loop_publish_parser.add_argument("--repo-root", help="Explicit ai-kit repository root.")
...
def add_asset_config_parser(subparsers: Any) -> None:
    ...
    p.add_argument("--repo-root", help="Explicit ai-kit repository root.")
