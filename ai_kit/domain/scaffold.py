...
from ai_kit.domain.inventory import load_cli_record, load_skill_record
from ai_kit.infrastructure.git_ops_extra import normalize_module_name
from ai_kit.infrastructure.release_ops import ensure_catalog_entry
    ...
    (package_dir / "config.py").write_text(
        "\n".join(
            [
                ...
                f'    """Return ~/.ai-kit/state/{cli_id}/, creating if needed."""',
