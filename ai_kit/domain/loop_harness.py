...
if TYPE_CHECKING:
    from ai_kit.domain.loop_workspace import WorkspaceHandle
...
from ai_kit.domain.loop_state import LoopState, load_state, save_state
...
class LoopHarnessImpl(LoopHarness):
    ...
    def __init__(self) -> None:
        from ai_kit.domain.loop_checker import CheckerSpawner
        from ai_kit.domain.loop_convergence import ConvergenceDetector
        from ai_kit.domain.loop_escalation import EscalationChannel
        from ai_kit.domain.loop_maker import MakerExecutor
        from ai_kit.domain.loop_workspace import WorkspaceManager
    ...
    def spawn_checker(
        ...
        if mode == ExecutionMode.SUB_AGENT:
            ...
            from ai_kit.domain.loop_contract import Rubric
