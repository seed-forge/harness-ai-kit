...
from ai_kit.domain.loop_harness import LoopHarness, LoopHarnessImpl, LoopProfile
from ai_kit.domain.loop_lock import LoopLockManager
from ai_kit.domain.loop_manifest import LoopManifest
from ai_kit.domain.loop_runtime import LoopRuntime
from ai_kit.domain.loop_state import (
...
class LoopDriver:
    ...
    def _one_iteration(
        ...
        # Checker spawn
        from ai_kit.domain.loop_harness import CheckerContext
    ...
    def _record_iteration(
        ...
        from ai_kit.domain.loop_state import ConvergenceMetricEntry
