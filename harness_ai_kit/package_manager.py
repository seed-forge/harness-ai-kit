...
from harness_ai_kit.domain.lockfile import SCHEMA_VERSION, LockNode, Lockfile, RootRequest
from harness_ai_kit.domain.lockfile_io import (
    LOCKFILE_NAME,
    lockfile_path,
    read_lockfile,
...
from harness_ai_kit.domain.manifest import (
...
from harness_ai_kit.domain.registry import (
...
from harness_ai_kit.domain.resolver import DiscoveredGitSkill, GitRepoCheckout, GitSkillResolver, GitSourceSpec, ResolutionProvider
from harness_ai_kit.domain.resolver import build_resolution_plan as _build_resolution_plan
from harness_ai_kit.domain.resolver import (
...
from harness_ai_kit.domain.resolution import DependencyRequirement, PackageCandidate, ResolutionPlan, utc_now_iso
from harness_ai_kit.domain.versions import PINNED_VERSION_PATTERN, ensure_version, is_pinned_specifier
