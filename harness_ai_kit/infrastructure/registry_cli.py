...
from harness_ai_kit.domain.models import CliAssetRecord, CliConfig, ProjectManifest, ProjectVersionedAssetSpec
from harness_ai_kit.domain import cli_assets
from harness_ai_kit.domain import project_locking
from harness_ai_kit.domain.manifest_ops import declared_cli_specs
...
def resolve_cli_record_from_registry(
    ...
    from harness_ai_kit.domain.inventory import cli_record_from_payload
...
def merge_manifest_cli_into_refresh_lockfile(
    ...
    *,
    ...
    from harness_ai_kit.domain.inventory import load_combined_cli_inventory
    if offline:
        return lockfile
