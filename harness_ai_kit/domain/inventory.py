...
from harness_ai_kit.infrastructure.config_io import read_json_file
...
def load_skill_inventory_for_source(
    ...
    if source == "repo":
        if repo_root is None:
            raise FileNotFoundError("Local harness-ai-kit repository is not available. Bootstrap first or pass --repo-root.")
