...
from harness_ai_kit.infrastructure.config_io import pyproject_path, read_project_version
...
def expand_skill_ids_with_dependencies(
    ...
    from harness_ai_kit.infrastructure.registry_skill import download_skill_metadata
